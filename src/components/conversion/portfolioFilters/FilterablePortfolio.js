...
const ProjectCard = ({ project, viewMode, t }) => {
    ...
    <div className="filterable-portfolio py-8">
      ...
      <div className="flex justify-between items-center mb-6">
        <span className="text-sm text-gray-600 dark:text-gray-400">
          {t.showing} <span className="font-medium text-dark dark:text-light">{filteredProjects.length}</span> {t.of} {allProjects.length} {t.projects}
        </span>
      ...
      <AnimatePresence>
        {filteredProjects.length === 0 ? (
          ...
          >
            <h3 className="text-xl font-bold text-gray-700 dark:text-gray-300 mb-2">{t.noMatchTitle}</h3>
            <p className="text-gray-600 dark:text-gray-400 mb-4">{t.noMatchDesc}</p>
            <button
